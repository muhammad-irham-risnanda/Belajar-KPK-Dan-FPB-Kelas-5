        ...
        <div class="container mt-4">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="p-4 content-box rounded border-black shadow-sm">
                        <h5><a href="<?php echo base_url('index.php/pages/kpk_materi'); ?>"
                ...
                <div class="col-md-3">
                    <div class="p-4 content-box rounded border-black shadow-sm">
                        <h5><a href="<?php echo base_url('index.php/pages/fpb_materi'); ?>"
                ...
                <div class="col-md-3">
                    <div class="p-4 content-box rounded border-black shadow-sm">
                        <h5> <a href="<?php echo base_url('index.php/pages/faktor_prima_materi'); ?>"
                ...
                <div class="mt-4">
                    <div class="mt-4 p-4 content-box rounded">
                        ...
                        <p>Pada akhir fase C, peserta didik dapat menunjukkan pemahaman dan intuisi bilangan (number
                            ...
                            Mereka dapat membaca, menulis, menentukan nilai tempat, membandingkan, mengurutkan,
                            melakukan
                            komposisi dan dekomposisi bilangan tersebut.
                            Mereka juga dapat menyelesaikan masalah yang berkaitan dengan uang.
                            Mereka dapat melakukan operasi penjumlahan, pengurangan, perkalian, dan pembagian bilangan
                            cacah
                            sampai 100.000.
            ...
            <div class="container mt-4">
                <h1 class="h3 text-center">Media Pembelajaran ini dibuat Untuk Memenuhi Persyaratan dalam Menyelesaikan
                    ...
                    Pengembangan Media Pembelajaran Interaktif Berbasis Web Pada Materi FPB Dan KPK Kelas V Dengan
                    metode
                    Demonstrasi</h1>
                <div class="mt-4 p-4 content-box rounded">
