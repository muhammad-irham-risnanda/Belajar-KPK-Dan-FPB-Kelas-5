<title>Video Materi Faktor Prima</title>
<style>
    body {
    ...
    <main class="p-4 flex-grow-1 overflow-auto">
        <div class="mt-4">
            <div class="mt-4 p-4 content-box rounded">
                <h2 class="underline">Video ringkasan materi Faktor Prima</h2>
                <video width="100%" height="500" controls>
                    <source src="<?php echo base_url() . 'assets/images/belajar_faktor_prima.mp4'; ?>" type="video/mp4">
                </video>
            </div>
        </div>
    </main>