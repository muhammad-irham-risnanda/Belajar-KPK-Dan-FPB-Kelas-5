...
<body class="d-flex flex-column min-vh-100 bg-light">
    ...
    <header class="bg-dark text-white p-3 text-center">
        <h1 class="h3 m-0"><i class="fas fa-stopwatch"></i> Evaluasi KPK</h1>
    </header>
    ...
    <main class="container py-4 flex-grow-1">
        ...
        <?= csrf_field() ?>
        <form id="examForm" action="<?= site_url('siswa/evaluasi/kpk/submit'); ?>" method="post">
            <?php $no = 1;
