            ...
            <div class="col-md-8">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form id="quizForm" action="<?php echo site_url('pages/submit_soal_evaluasi'); ?>" method="post">
                        <?php foreach ($evaluasis as $index => $evaluasi): ?>
                            <div class="question">
                                <p><?php echo ($index + 1) . ". " . $evaluasi->question; ?></p> <!-- Menambahkan nomor pertanyaan -->
                                <label><input type="radio" name="answer_<?php echo $evaluasi->id; ?>" value="A" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $evaluasi->option_a; ?></label><br>
                                <label><input type="radio" name="answer_<?php echo $evaluasi->id; ?>" value="B" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $evaluasi->option_b; ?></label><br>
                                <label><input type="radio" name="answer_<?php echo $evaluasi->id; ?>" value="C" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $evaluasi->option_c; ?></label><br>
                                <label><input type="radio" name="answer_<?php echo $evaluasi->id; ?>" value="D" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $evaluasi->option_d; ?></label><br>
                            </div>
                        <?php endforeach; ?>
