            ...
            <div class="col-md-8">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form id="quizForm" action="<?php echo site_url('pages/submit_soal_fpb'); ?>" method="post">
                        <?php foreach ($fpbs as $index => $fpb): ?>
                            <div class="question">
                                <p><?php echo ($index + 1) . ". " . $fpb->question; ?></p> <!-- Menambahkan nomor pertanyaan -->
                                <label><input type="radio" name="answer_<?php echo $fpb->id; ?>" value="A" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $fpb->option_a; ?></label><br>
                                <label><input type="radio" name="answer_<?php echo $fpb->id; ?>" value="B" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $fpb->option_b; ?></label><br>
                                <label><input type="radio" name="answer_<?php echo $fpb->id; ?>" value="C" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $fpb->option_c; ?></label><br>
                                <label><input type="radio" name="answer_<?php echo $fpb->id; ?>" value="D" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $fpb->option_d; ?></label><br>
                            </div>
                        <?php endforeach; ?>
