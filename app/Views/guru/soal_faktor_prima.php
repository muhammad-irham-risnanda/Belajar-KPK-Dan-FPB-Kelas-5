...
<div class="container mt-4">
    ...
    <h2 class="mb-3">Soal Faktor Prima</h2>

    <!-- Search Bar -->
    <form method="get" action="<?php echo site_url('welcome/soal_faktor_prima'); ?>" class="mb-4">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <?php if (!empty($faktor_prima)): ?>
                    <?php foreach ($faktor_prima as $item): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('welcome/edit_faktor_prima/' . $item->id); ?>"
                                    class="btn btn-warning btn-sm">Edit</a>
                                <a href="<?php echo site_url('welcome/delete_faktor_prima/' . $item->id); ?>"
        ...
        <a href="<?php echo site_url('welcome/create_faktor_prima'); ?>" class="btn btn-primary mb-3">Tambah
            Pertanyaan</a>
    ...
    <div class="text-center mb-4">
        ...
        <a href="<?php echo site_url('welcome/soal_faktor_prima'); ?>" class="btn btn-secondary active-link">Lihat Soal
            Faktor Prima</a>
