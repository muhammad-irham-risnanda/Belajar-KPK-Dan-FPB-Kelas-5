...
<div class="container mt-4">
  ...
  <h2 class="mb-3">Nilai Evaluasi</h2>

  <!-- Search Bar -->
  <form method="GET" action="<?php echo site_url('welcome/nilai_evaluasi'); ?>" class="mb-4">
  ...
  <div class="text-center mb-4">
    ...
    <a href="<?php echo site_url('welcome/nilai_faktor_prima'); ?>" class="btn btn-secondary">Lihat Nilai Faktor
      Prima</a>
    <a href="<?php echo site_url('welcome/nilai_evaluasi'); ?>" class="btn btn-secondary active-link">Lihat Nilai
      Evaluasi</a>
  </div>
</div>
</div>