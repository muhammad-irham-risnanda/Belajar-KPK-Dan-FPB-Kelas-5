...
<div class="container mt-4">
    ...
    <h2 class="mb-3">Nilai Materi FPB</h2>

    <!-- Search Bar -->
    <form method="GET" action="<?php echo site_url('welcome/nilai_fpb'); ?>" class="mb-4">
    ...
    <div class="text-center mb-4">
        ...
        <a href="<?php echo site_url('welcome/nilai_fpb'); ?>" class="btn btn-secondary active-link">Lihat Nilai FPB</a>
