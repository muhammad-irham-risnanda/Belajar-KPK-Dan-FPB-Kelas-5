        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <h4><i class="fas fa-list"></i> Daftar Soal FPB</h4>
                    <a href="<?= base_url('/guru/fpb/create'); ?>" class="btn btn-success">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php if (!empty($fpbList)): ?>
                            <?php foreach ($fpbList as $index => $fpb): ?>
                                <tr>
                                    <td><?= $index + 1; ?></td>
                                    <td><?= esc($fpb['question']); ?></td>
                                    <td><?= esc($fpb['option_a']); ?></td>
                                    <td><?= esc($fpb['option_b']); ?></td>
                                    <td><?= esc($fpb['option_c']); ?></td>
                                    <td><?= esc($fpb['option_d']); ?></td>
                                    <td><strong><?= esc($fpb['answer']); ?></strong></td>
                                    <td>
                                        <a href="<?= base_url('/guru/fpb/edit/' . $fpb['id']); ?>"
                                            class="btn btn-sm btn-warning">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="<?= base_url('/guru/fpb/delete/' . $fpb['id']); ?>"
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="8" class="text-center text-muted">Belum ada soal FPB.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
