    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="d-flex justify-content-between align-items-center mb-2">
          <h4><i class="fas fa-list"></i> Daftar Soal Faktor Prima</h4>
          <a href="<?= base_url('/guru/faktor-prima/create'); ?>" class="btn btn-success">
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            <?php if (!empty($faktorPrimaList)): ?>
              <?php foreach ($faktorPrimaList as $index => $fp): ?>
                <tr>
                  <td><?= $index + 1; ?></td>
                  <td><?= esc($fp['question']); ?></td>
                  <td><?= esc($fp['option_a']); ?></td>
                  <td><?= esc($fp['option_b']); ?></td>
                  <td><?= esc($fp['option_c']); ?></td>
                  <td><?= esc($fp['option_d']); ?></td>
                  <td><strong><?= esc($fp['answer']); ?></strong></td>
                  <td>
                    <a href="<?= base_url('/guru/faktor-prima/edit/' . $fp['id']); ?>" class="btn btn-sm btn-warning">
                      <i class="fas fa-edit"></i>
                    </a>
                    <a href="<?= base_url('/guru/faktor-prima/delete/' . $fp['id']); ?>" class="btn btn-sm btn-danger"
            ...
            <?php else: ?>
              <tr>
                <td colspan="8" class="text-center text-muted">Belum ada soal Faktor Prima.</td>
              </tr>
            <?php endif; ?>
          </tbody>
        </table>
