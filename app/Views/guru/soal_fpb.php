...
<div class="container mt-4">
    ...
    <h2 class="mb-3">Soal FPB</h2>

    <!-- Search Bar -->
    <form method="get" action="<?php echo site_url('welcome/soal_fpb'); ?>" class="mb-4">
                ...
                <?php if (!empty($fpb)): ?>
                    <?php foreach ($fpb as $item): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('welcome/edit_fpb/' . $item->id); ?>"
                                    class="btn btn-warning btn-sm">Edit</a>
                                <a href="<?php echo site_url('welcome/delete_fpb/' . $item->id); ?>"
    ...
    <div class="text-center mb-4">
        ...
        <a href="<?php echo site_url('welcome/soal_fpb'); ?>" class="btn btn-secondary active-link">Lihat Soal FPB</a>
