...
<div class="container mt-4">
    ...
    <h2 class="mb-3">Nilai Materi KPK</h2>

    <!-- Search Bar -->
    <form method="GET" action="<?php echo site_url('welcome/nilai_kpk'); ?>" class="mb-4">
    ...
    <div class="text-center mb-4">
        <a href="<?php echo site_url('welcome/nilai_kpk'); ?>" class="btn btn-secondary active-link">Lihat Nilai KPK</a>
